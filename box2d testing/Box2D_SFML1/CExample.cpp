...
CExample::CExample(sf::RenderWindow* _renderWindow, b2World& m_World, const float& _scale)
{
...
void CExample::Update(b2Body* _bodyIterator)
{
...
sf::RectangleShape CExample::GetShape()
{
	return m_Shape;
}
